...
// Same Adapter interface as fileAdapter. Engine never knows the difference.
//
// Supported now:   postgres, mongodb (stub)
// Prepared for:    mysql, sqlserver, sqlite, redis, cosmos, dynamo
// To add a new DB: implement Adapter, add a case in newDBAdapter().
package main
...
func (a *dbAdapter) GetProject(name string) (*Project, error) {
	var p Project
...
func (a *dbAdapter) ListProjects() ([]ProjectSummary, error) {
	rows, err := a.db.Query(`
...
func (a *dbAdapter) Search(query, domain string) ([]SearchResult, error) {
...
func (a *dbAdapter) searchPostgres(query, domain string) ([]SearchResult, error) {
	rows, err := a.db.Query(`
...
func (a *dbAdapter) searchLike(query, domain string) ([]SearchResult, error) {
...
func (a *dbAdapter) DeleteMemory(project string, req MemoryDeleteRequest) (int, error) {
